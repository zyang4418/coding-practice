...
void* winrt_make_WinUI3_XamlMetaDataProvider();
...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"WinUI3.MainWindow"))
    {
        return winrt_make_WinUI3_MainWindow();
    }

    if (requal(name, L"WinUI3.XamlMetaDataProvider"))
    {
        return winrt_make_WinUI3_XamlMetaDataProvider();
    }
