...
namespace winrt::WinUI3::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, WinUI3::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = WinUI3::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"WinUI3.XamlMetaDataProvider";
        }
    };
}
namespace winrt::WinUI3::factory_implementation
{
    ...
    {
        using instance_type = WinUI3::XamlMetaDataProvider;
